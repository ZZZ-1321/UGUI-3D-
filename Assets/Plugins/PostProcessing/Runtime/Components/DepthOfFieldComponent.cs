...
namespace UnityEngine.PostProcessing
{
    ...
    public sealed class DepthOfFieldComponent : PostProcessingComponentRenderTexture<DepthOfFieldModel>
    {
        ...
        public void Prepare(RenderTexture source, Material uberMaterial, bool antialiasCoC, Vector2 taaJitter, float taaBlending)
        {
            ...
            var rtCoC = context.renderTextureFactory.Get(tw, th, 0, cocFormat, RenderTextureReadWrite.Linear);
            ...
            var rt1 = context.renderTextureFactory.Get(tw / 2, th / 2, 0, colorFormat);
            material.SetTexture(Uniforms._CoCTex, rtCoC);
            Graphics.Blit(source, rt1, material, 2);

            // Bokeh simulation pass
            var rt2 = context.renderTextureFactory.Get(tw / 2, th / 2, 0, colorFormat);
