    ...
    SubShader
	{
		...
		{      
            ...
            VertexOutput vert (VertexInput v)
			{
                ...
                o.uv0 = v.texcoord0;
				o.uv_Mask = TRANSFORM_TEX(v.texcoord0, _Mask);
...
////// Emissive:
                ...
                half4 _Mask_var = tex2D(_Mask,i.uv_Mask);
                half3 emissive = ((_Color.rgb*_Texture_var.rgb*_Value*i.vertexColor.rgb*i.vertexColor.a)*_Mask_var.rgb);
